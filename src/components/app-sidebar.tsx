...
import { LayoutDashboard, FileText, ListChecks, Search, MessageSquare, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <Link to="/" className="flex items-center gap-2 px-2 py-3">
          ...
          <div className="flex flex-col group-data-[collapsible=icon]:hidden">
            <span className="font-display text-sm font-semibold leading-tight">Workplace</span>
            <span className="text-xs text-muted-foreground leading-tight">AI Assistant</span>
          </div>
        </Link>
      </SidebarHeader>
      <SidebarContent>
